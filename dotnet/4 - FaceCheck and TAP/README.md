...
3. Change the branding image to your company's brand image by updating the value in appsettings.json and then copying it over to wwwroot 
...
The endpoint of the API is https://verifiedid.did.msidentity.com/beta/verifiableCredentials/createPresentationRequest 

> **Important**: At this moment FaceCheck is in preview hence the API endpoint is from /beta path.
